...
### Настройка веб хука
В личном [кабинете CloudPayments](https://merchant.cloudpayments.ru/Account/Login) в настройках вашего сайта вставьте следующие URL для коректной работы модуля:
* (Уведомлений о кассовых чеках:)  
`http(s)://domain.ru/cloudkassir/receipt`
